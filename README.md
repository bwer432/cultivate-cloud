[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/bwer432/cultivate-cloud) 
...
2. prepend `gitpod.io#` to the beginning of your github url. Mine becomes: `https://gitpod.io#github.com/bwer432/cultivate-cloud`
...
`git clone git@github.com:bwer432/cultivate-cloud.git` (or your fork)
...
deployed hash at the bottom of the menu panel.
An example is the "jenkinsworld" branch would be deployed to https://cultivate-cloud.com/jenkinsworld/
